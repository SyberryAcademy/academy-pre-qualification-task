...
**МЫ ПОМЕНЯЛИ ДАТЫ НАБОРА. ПОСЛЕДНИЙ ДЕНЬ ПОДАЧИ ЗАЯВКИ - 3 МАЯ**
...
## Как подать заявку
**Заявки принимаются с 5 апреля по 3 мая**. Чем раньше вы пришлете заявку, тем лучше: у вас будет больше времени на выполнение тестового и на прохождение технического интервью.<br>
